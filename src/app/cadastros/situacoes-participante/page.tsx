...
export default function SituacoesParticipantePage() {
  ...
  async function fetchSituacoes(pagina: number) {
    setLoading(true);
    try {
      // Ajuste para a rota criada no backend
      const response = await api.get(`/situacao-participante?page=${pagina}&limit=10`);
      ...
      <div className="flex flex-col w-full h-full">
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal}>
          ...
          <div className="p-4 grid grid-cols-1 gap-4">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-sm font-semibold text-gray-600">
                Tipo da Situação (Máx 50) <span className="text-red-500">*</span>
              </label>
              <input
                name="tipo_situacao"
